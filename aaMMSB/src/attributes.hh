...
typedef std::pair<uint32_t,  double vector[dG] > NodeAttrG;
typedef std::pair<uint32_t,  bool vector[dB] > NodeAttrB;

class Attributes: public std::pair<uint32_t, double vector[dG]> {
public:
  typedef std::pair<uint32_t, uint32_t>  inherited;
  Attributes(): inherited() { }
  Attributes(uint32_t a, uint32_t b): inherited(a,b) { }
};
